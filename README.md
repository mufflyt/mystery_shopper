...
![image](https://github.com/user-attachments/assets/aa8093f0-6597-4b04-b104-89cfa7237cc1)
https://docs.ropensci.org/npi/index.html
...
## Phase 2 Start calling instructions
...
## Phase 2 Second day calling e-mail
```
Dear All,
...
## Phase 2 Not Making Our Numbers
```
Hi Michaele,
...
## Phase 2 Email of concern that we are not going to finish on time.
```
...
## Phase 3 E-mail to society about incorrect phone numbers in the patient-facing database
```r
Hi Michaele,
